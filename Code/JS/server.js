...
app.use(session({
    secret: 'Terra Scenik-secret-key-2025', // signs session cookie
...
const MONGODB_URI = 'mongodb+srv://kahmeddurrani_db_user:Itsmypassword%401@kad.ssma5p1.mongodb.net/travelconnect?retryWrites=true&w=majority';
